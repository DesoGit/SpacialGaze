...
exports.commands = {
	...
	checkroomrequest: function (target, room, user) {
		...
		let output = `<center><h1>Tsunami Room Request</h1></center><b>Requester</b>: ${target} <br/><b>Room Name</b>: ${curRequest.name}<br/><b>Room Type</b>: ${curRequest.type}<br/><b>Description</b>: ${curRequest.desc}<br/>`;
