...
<<<<<<< HEAD:tsunami-plugins/icons.js
			this.sendReply("|raw|You have given " + Tsunami.nameColor(target[0], true) + " an icon.");
			Rooms('staff').add('|raw|' + Tsunami.nameColor((target[0])) + ' has received an icon from ' + Tsunami.nameColor(user.name), true).update();
=======
...
>>>>>>> cebf028be00159bef82262fb9c1b200b5f6cab60:spacialgaze-plugins/icons.js
			this.privateModCommand("|raw|(" + target[0] + " has recieved icon: <img src='" + target[1] + "' width='32' height='32'> from " + user.name + ".)");
			if (Users(target[0]) && Users(target[0]).connected) Users(target[0]).popup("|html|" + Tsunami.nameColor(user.name, true) + " has set your userlist icon to: <img src='" + target[1] + "' width='32' height='32'><br><center>Refresh, If you don't see it.</center>");
...
<<<<<<< HEAD:tsunami-plugins/icons.js
			Rooms('staff').add('|raw|' + Tsunami.nameColor(user.name, true) + " removed " + target + "'s icon.").update();
=======
			Monitor.adminlog(user.name + " removed " + target + "'s icon.");
>>>>>>> cebf028be00159bef82262fb9c1b200b5f6cab60:spacialgaze-plugins/icons.js
			this.privateModCommand("(" + target + "'s icon was removed by " + user.name + ".)");
			if (Users(target) && Users(target).connected) Users(target).popup("|html|" + Tsunami.nameColor(user.name, true) + " has removed your userlist icon.");
		},
	},
	iconhelp: [
		"Commands Include:",
