...
exports.commands = {
	...
	hex: function (target, room, user) {
		...
		this.sendReplyBox('The hex code of ' + Tsunami.nameColor(targetUser, true) + ' is: <font color="' + Tsunami.hashColor(targetUser) + '"><b>' + Tsunami.hashColor(targetUser) + '</b></font>');
	},
};
...
// hashColor function
Tsunami.hashColor = function (name) {
	name = toId(name);
